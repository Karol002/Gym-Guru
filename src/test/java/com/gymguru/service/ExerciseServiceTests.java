...
public class ExerciseServiceTests {
    ...
    @Test
    void testFindExercisesPlanId() throws EmailAlreadyExistException, TrainerPriceInCorrectException {
        //Given
        ...
        //When
        List<Exercise> exercises = exerciseService.getExercisesByPlanId(plan.getId());
    ...
    @Test
    void testUpdateExercise() throws EmailAlreadyExistException, TrainerPriceInCorrectException, ExerciseNotFoundException {
        //Given
        Credential user1Credential = new Credential("user1@example.com", "password1", CredentialType.ROLE_USER);
        Credential trainer1Credential = new Credential("trainer1@example.com", "password3", CredentialType.ROLE_TRAINER);
        ...
        //When
        exercise1.setDescription("Updated description");
        exercise1.setName("Updated name");
        exerciseService.updateExercise(exercise1);
        Exercise resultExercise = exerciseService.getExercisesByPlanId(plan.getId()).get(0);

        //Then
        assertEquals("Updated name", resultExercise.getName());
        assertEquals("Updated description", resultExercise.getDescription());
    }
    ...
    void testCascadeWhenDeletePlan() throws EmailAlreadyExistException, TrainerPriceInCorrectException {
        ...
        //When
        int sizeBeforeDelete = exerciseService.getExercisesByPlanId(plan.getId()).size();
        deleter.deleteFromPlans();
        int sizeAfterDelete = exerciseService.getExercisesByPlanId(plan.getId()).size();
